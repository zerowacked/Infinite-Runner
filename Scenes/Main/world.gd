...
var x_coordinate = 304 # this is the x coordinate of the last pixel of the start platform
...
func spawn_platform():
	...
	var spawn_x = increment_spawn_x_value()
	...
	newPlatform.position = Vector2(spawn_x+platform_length_increment,spawn_y)
...
func randomize_blank_space(x):
	var random_addition = randi_range(300,500)
